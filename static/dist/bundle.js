...
var TypedController = /*#__PURE__*/function () {
  /**
   *
   */
  function TypedController() {
    _classCallCheck(this, TypedController);
  ...
  _createClass(TypedController, [{
    ...
    value: function init() {
      ...
      if (this.typed !== null) {
        ...
        console.error("".concat(this.DOM.typed, " does not exist in the DOM!"));
      }
    }
  }, {
    key: "initTyped",
    value: function initTyped() {
      new _typed.default(this.DOM.typed, {
...
exports.default = TypedController;

},{"typed.js":1}],5:[function(require,module,exports){
"use strict";

var _GridHelper = _interopRequireDefault(require("./components/GridHelper"));

var _TypedController = _interopRequireDefault(require("./components/TypedController"));
...
ready(function () {
  var copyright = ["background-color: #000000", "color: white", "display: block", "line-height: 24px", "text-align: center", "border: 1px solid #ffffff", "font-weight: bold"].join(";");
  console.info("dev by: %c Bornfight ", copyright);
  var gridHelper = new _GridHelper.default();
  gridHelper.init();
  var typed = new _TypedController.default();
  typed.init();
  var navigation = new _NavigationController.default();
  navigation.init();
});

},{"./components/GridHelper":2,"./components/NavigationController":3,"./components/TypedController":4}]},{},[5]);
